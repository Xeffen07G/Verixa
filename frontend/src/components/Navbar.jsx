...
import { Menu, X, Sun, Moon, Globe, Image, Video, BookOpen, TrendingUp, LogOut, User, FileText, Layout } from 'lucide-react';
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <Link to="/research" onClick={() => setMobileOpen(false)} style={{ display: 'flex', alignItems: 'center', gap: 16, padding: '16px 20px', borderRadius: 14, background: 'rgba(255,255,255,0.03)', color: textColor, textDecoration: 'none' }}>
              <BookOpen size={20} />
              <span style={{ fontSize: 18, fontWeight: 700 }}>{t('researchWorkspace', lang) || 'Research Workspace'}</span>
            </Link>
